...
public class Engine {
     ...
     *
     * @param isDebug <tt>true</tt> set debug mode to enable, <tt>false</tt> set debug mode to disable
     */
     ...
     *
     * @param isCached <tt>true</tt> set cache mode to enable, <tt>false</tt> set cache mode to disable
     */
     ...
     * @param isFunction <tt>true</tt> if function is created, otherwise variable modifier is created
